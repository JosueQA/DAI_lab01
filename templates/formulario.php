<?php include_once 'includes/contactos_crud.php'; ?>
...
<form
    ...
    <input type="text" id="nombre" name="nombre" class="form-control" required
           ...
           value="<?= editar_contacto_valores(0); ?>">
    ...
    <?php
    if (!empty(editar_contacto_valores(3))) {
        echo '<img src="assets/imagenes/' . htmlspecialchars(editar_contacto_valores(3)) . '" alt="Foto" style="width:100px; border-radius:8px;">';
    } else {
        echo 'Sin foto';
    }; ?>
    ...
    if ((editar_contacto_valores(0)) != "") {
        echo '<button type="submit" class="btn btn-success mt-3">Editar</button>';
    } else {
